...
param(
    ...
    [string]$Publisher = "CN=ShlomiPorush",
    [string]$PublisherDisplayName = "Shlomi Porush",
    [string]$PackageName = "ShlomiPorush.AIUsageTray",
    [string]$DisplayName = "AI Usage Tray",
...
$msixName = "ai-usage-tray-win-$Platform-v$Version.msix"
...
$appinstallerPath = Join-Path $publishRoot "ai-usage-tray-win-$Platform.appinstaller"
