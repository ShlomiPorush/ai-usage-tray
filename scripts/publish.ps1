<#
.SYNOPSIS
    Publishes AI Usage Tray for Windows x64 and ARM64.
...
Write-Host "Building AI Usage Tray v$Version" -ForegroundColor Cyan
...
foreach ($rid in $platforms) {
    ...
    # Create ZIP archive
    $zipPath = Join-Path $outputBase "ai-usage-tray-$rid-v$Version.zip"
