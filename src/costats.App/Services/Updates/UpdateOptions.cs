...
public sealed class UpdateOptions
{
    ...
    public string Repository { get; init; } = "ShlomiPorush/ai-usage-tray";
    ...
    public static UpdateOptions FromConfiguration(IConfiguration configuration)
    {
        ...
        return new UpdateOptions
        {
            ...
            Repository = string.IsNullOrWhiteSpace(section["Repository"]) ? "ShlomiPorush/ai-usage-tray" : section["Repository"]!.Trim(),
